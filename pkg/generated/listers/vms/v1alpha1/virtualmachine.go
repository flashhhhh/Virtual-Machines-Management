...
type VirtualMachineLister interface {
	...
	List(selector labels.Selector) (ret []*vmsv1alpha1.VirtualMachine, err error)
...
type virtualMachineLister struct {
	listers.ResourceIndexer[*vmsv1alpha1.VirtualMachine]
}
...
func NewVirtualMachineLister(indexer cache.Indexer) VirtualMachineLister {
	return &virtualMachineLister{listers.New[*vmsv1alpha1.VirtualMachine](indexer, vmsv1alpha1.Resource("virtualmachine"))}
}

// VirtualMachines returns an object that can list and get VirtualMachines.
func (s *virtualMachineLister) VirtualMachines(namespace string) VirtualMachineNamespaceLister {
	return virtualMachineNamespaceLister{listers.NewNamespaced[*vmsv1alpha1.VirtualMachine](s.ResourceIndexer, namespace)}
}
...
type VirtualMachineNamespaceLister interface {
	...
	// Objects returned here must be treated as read-only.
	Get(name string) (*vmsv1alpha1.VirtualMachine, error)
