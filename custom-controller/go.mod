module github.com/flashhhhh/Virtual-Machines-Management/custom-controller
...
require (
	...
	github.com/flashhhhh/Virtual-Machines-Management/custom-apiserver v0.0.0-20250731093138-8231f8bf39f2
