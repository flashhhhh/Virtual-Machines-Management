...
func GetOpenAPIDefinitions(ref common.ReferenceCallback) map[string]common.OpenAPIDefinition {
	return map[string]common.OpenAPIDefinition{
		"github.com/flashhhhh/Virtual-Machines-Management/custom-apiserver/pkg/apis/vms/v1alpha1.VirtualMachine":       schema_pkg_apis_vms_v1alpha1_VirtualMachine(ref),
		"github.com/flashhhhh/Virtual-Machines-Management/custom-apiserver/pkg/apis/vms/v1alpha1.VirtualMachineList":   schema_pkg_apis_vms_v1alpha1_VirtualMachineList(ref),
		"github.com/flashhhhh/Virtual-Machines-Management/custom-apiserver/pkg/apis/vms/v1alpha1.VirtualMachineSpec":   schema_pkg_apis_vms_v1alpha1_VirtualMachineSpec(ref),
		"github.com/flashhhhh/Virtual-Machines-Management/custom-apiserver/pkg/apis/vms/v1alpha1.VirtualMachineStatus": schema_pkg_apis_vms_v1alpha1_VirtualMachineStatus(ref),
...
func schema_pkg_apis_vms_v1alpha1_VirtualMachine(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
			...
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					...
					"spec": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref("github.com/flashhhhh/Virtual-Machines-Management/custom-apiserver/pkg/apis/vms/v1alpha1.VirtualMachineSpec"),
						},
					},
					"status": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref("github.com/flashhhhh/Virtual-Machines-Management/custom-apiserver/pkg/apis/vms/v1alpha1.VirtualMachineStatus"),
						},
					},
				},
			},
		...
		Dependencies: []string{
			"github.com/flashhhhh/Virtual-Machines-Management/custom-apiserver/pkg/apis/vms/v1alpha1.VirtualMachineSpec", "github.com/flashhhhh/Virtual-Machines-Management/custom-apiserver/pkg/apis/vms/v1alpha1.VirtualMachineStatus", "k8s.io/apimachinery/pkg/apis/meta/v1.ObjectMeta"},
	}
}

func schema_pkg_apis_vms_v1alpha1_VirtualMachineList(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
						...
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Default: map[string]interface{}{},
										Ref:     ref("github.com/flashhhhh/Virtual-Machines-Management/custom-apiserver/pkg/apis/vms/v1alpha1.VirtualMachine"),
									},
								},
							},
						},
		...
		Dependencies: []string{
			"github.com/flashhhhh/Virtual-Machines-Management/custom-apiserver/pkg/apis/vms/v1alpha1.VirtualMachine", "k8s.io/apimachinery/pkg/apis/meta/v1.ListMeta"},
	}
}

func schema_pkg_apis_vms_v1alpha1_VirtualMachineSpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
				...
				Required: []string{"image", "size", "sshKeyIDs", "subnetID", "securityGroupIDs"},
			},
		},
	}
}

func schema_pkg_apis_vms_v1alpha1_VirtualMachineStatus(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
