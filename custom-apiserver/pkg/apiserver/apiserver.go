...
import (
	...
	"github.com/flashhhhh/Virtual-Machines-Management/custom-apiserver/pkg/apis/vms/install"
...
func (c CompletedConfig) New() (*VirtualMachineServer, error) {
	genericServer, err := c.GenericConfig.New("github.com/flashhhhh/Virtual-Machines-Management/custom-apiserver", genericapiserver.NewEmptyDelegate())
	if err != nil {
		return nil, err
	}
